...
import com.example.TransferenciaService.entities.TokenValidacao;
import com.example.TransferenciaService.entities.TokenValidacao;
import com.example.TransferenciaService.https.utils.ResponseBody;
import com.example.TransferenciaService.services.implementacao.TokenValidacaoServiceImpl;
...
public class TokenValidacaoController extends BaseController{
    ...
    public ResponseEntity<ResponseBody> findAllTokenValidacaos()
    {
        ...
        return this.ok("Canais encontradas com sucesso!", lista);
    }
