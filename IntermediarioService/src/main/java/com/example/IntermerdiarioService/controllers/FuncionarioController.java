...
import com.example.IntermerdiarioService.entities.Funcionario;
import com.example.IntermerdiarioService.https.utils.ResponseBody;
import com.example.IntermerdiarioService.services.implementacao.FuncionarioServiceImpl;
...
public class FuncionarioController extends BaseController {
    ...
    @GetMapping
    public ResponseEntity<ResponseBody> findAllFuncionarios()
    {
    ...
    {
        ResponseEntity<ResponseBody> FuncionarioResponse = this.created("Funcionario adicionado com sucesso.", this.funcionarioServiceImpl.criar(Funcionario));
